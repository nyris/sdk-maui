...
public class PinView extends View {
    ...
    Paint mCirclePaint;
    float mStrokeContainerCirclePx, mRadiusContainerCirclePX, mRadiusCirclePx, mSizeView;
    ...
    public PinView(final Context context, final RectF region) {
        ...
        mRadiusCirclePx = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, RADIUS_CIRCLE_DP, r.getDisplayMetrics());
    ...
    public void onDraw(final Canvas canvas) {
        if (region != null) {
            ...
            canvas.drawCircle(center, center, mRadiusCirclePx, mCirclePaint);
        }
    }
