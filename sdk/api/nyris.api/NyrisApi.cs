...
public sealed class NyrisApi : INyrisApi
{
    ...
    [NotNull]
    public static INyrisApi CreateInstance([NotNull] string apiKey, Platform platform,
        HttpClientHandler httpClientHandler = null, bool isDebug = false)
    {
        return new NyrisApi(apiKey, platform, httpClientHandler, isDebug);
    }
}