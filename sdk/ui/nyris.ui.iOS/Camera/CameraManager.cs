...
namespace Nyris.UI.iOS.Camera
{
    public class CameraManager : AVCaptureVideoDataOutputSampleBufferDelegate
    {
        ...
        void ConfigureSession (CameraConfiguration configuration)
        {
			...
			// Add video input.
			CaptureDevice = AVCaptureDevice.GetDefaultDevice(mediaType: AVMediaTypes.Video);
            ...
            if (_captureSession.CanAddOutput(_videoOutput))
            {
                ...
                _videoOutput.SetSampleBufferDelegate(this, SessionQueue);
                var videoOutputConnection = _videoOutput.ConnectionFromMediaType(AVMediaTypes.Video.GetConstant());
