...
{
    public static NyrisSearcherResult ToNyrisSearcherResult(this OfferResponseDto responseDto, byte[]? screenshot = null)
    {
        ...
        return new NyrisSearcherResult(responseDto.RequestCode, offers, predictedCategories, screenshot);
    }
}